...
```
cd existing_repo
git remote add origin https://gitlab.com/harel.mathis-group/techflow.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/harel.mathis-group/techflow/-/settings/integrations)
